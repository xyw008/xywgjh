...
- (void)viewDidLoad
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageWithColor:HEXCOLOR(0X3c3a47) size:CGSizeMake(1, 1)] forBarMetrics:UIBarMetricsDefault];
