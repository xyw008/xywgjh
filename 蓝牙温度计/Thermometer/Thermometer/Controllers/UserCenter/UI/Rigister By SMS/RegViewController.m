...
- (void)viewDidLoad
{
    ...
    [areaCodeField addBorderToViewWitBorderColor:CellSeparatorColor borderWidth:LineWidth];
    [areaCodeField setRadius:3];
    ...
    //
    NITextField* telField = [[NITextField alloc] init];
    ...
    [telField addBorderToViewWitBorderColor:CellSeparatorColor borderWidth:LineWidth];
    [telField setRadius:3];
    telField.textInsets = UIEdgeInsetsMake(0, 10, 0, 0);
