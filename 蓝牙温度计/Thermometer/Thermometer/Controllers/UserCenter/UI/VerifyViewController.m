...
- (void)viewDidLoad
{
    ...
    */
    UIBarButtonItem *leftButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel
                                                                                target:self
                                                                                action:@selector(clickLeftButton)];
    [self.navigationItem setTitle:NSLocalizedString(@"verifycode", nil)];
    ...
    _verifyCodeField = [[NITextField alloc] init];
    ...
    [_verifyCodeField addBorderToViewWitBorderColor:CellSeparatorColor borderWidth:LineWidth];
    [_verifyCodeField setRadius:3];
