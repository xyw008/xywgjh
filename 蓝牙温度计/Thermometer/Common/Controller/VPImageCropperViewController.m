...
- (void)initView {
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 320, 200)];
...
- (void)confirm:(id)sender {
    if (_delegate && [_delegate respondsToSelector:@selector(imageCropper:didFinished:)]) {
        [_delegate imageCropper:self didFinished:[self getSubImage]];
    }
}
