...
- (id)initWithFrame:(CGRect)frame image:(UIImage *)image
{
    ...
    if (self) {
        ...
        UIImageView *coverImgView = [[UIImageView alloc] initWithImage:image];
        coverImgView.frame = self.bounds;
//        coverImgView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
