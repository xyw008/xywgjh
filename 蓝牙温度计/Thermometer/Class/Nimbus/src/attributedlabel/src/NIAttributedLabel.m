...
- (void)setText:(NSString *)text {
  ...
  [self.mutableAttributedString setKern:_textKern];
    /*
  [self.mutableAttributedString setStrikethroughStyle:_strikethroughStyle];
     */
}
...
- (void)setStrikethroughStyle:(CTUnderlineStyle)strikethroughStyle
{
    if (strikethroughStyle != _strikethroughStyle)
    {
        _strikethroughStyle = strikethroughStyle;
        [self.mutableAttributedString setStrikethroughStyle:strikethroughStyle];
        
        [self attributedTextDidChange];
    }
}

- (void)setStrikethroughStyle:(CTUnderlineStyle)style range:(NSRange)range
{
    [self.mutableAttributedString setStrikethroughStyle:style range:range];
