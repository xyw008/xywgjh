...
/*
@property (nonatomic)         CTUnderlineStyle          strikethroughStyle;     // 删除线样式(自定义添加的属性)
 */
...
/*
- (void)setStrikethroughStyle:(CTUnderlineStyle)style range:(NSRange)range;     // 设置删除线样式(自定义添加的方法)
 */
